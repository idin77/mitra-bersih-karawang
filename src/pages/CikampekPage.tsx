  ...
  return (
    <div id="mitra-bersih-cikampek-app" className="relative text-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-blue-950">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-display font-extrabold text-base sm:text-lg tracking-tight">Kredibilitas Bintang 5 di Cikampek</h4>
      ...
      <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
        <About location="Cikampek" />
        <Services whatsappNumber={WHATSAPP_NUMBER} location="Cikampek" />
